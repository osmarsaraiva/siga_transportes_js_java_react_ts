...
--
-- Host: localhost
-- Tempo de geração: 05-Jan-2023 às 18:27
...
CREATE TABLE `clientes` (
  ...
  `CNPJ` varchar(60) COLLATE utf8_bin NOT NULL,
  `ie` varchar(60) COLLATE utf8_bin NOT NULL,
...
CREATE TABLE `documentos` (
  `id` bigint(20) NOT NULL,
  `nome_doc` varchar(80) COLLATE utf8_bin NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE `doc_veiculos` (
  `id` int(11) NOT NULL,
  `nome_doc` varchar(60) COLLATE utf8_bin NOT NULL,
...
CREATE TABLE `empresas` (
  `id` bigint(20) NOT NULL,
  `nome` varchar(80) COLLATE utf8_bin NOT NULL,
  `CNPJ` varchar(80) COLLATE utf8_bin NOT NULL,
  `ie` varchar(80) COLLATE utf8_bin NOT NULL,
  `email` varchar(80) COLLATE utf8_bin NOT NULL,
  `endereco` varchar(100) COLLATE utf8_bin NOT NULL,
  `fk_cidades_id` bigint(20) NOT NULL,
  `fone` varchar(30) COLLATE utf8_bin NOT NULL,
  `responsavel` varchar(80) COLLATE utf8_bin NOT NULL,
...
CREATE TABLE `exames_medicos` (
  `id` int(11) NOT NULL,
  `nome_exame` varchar(60) COLLATE utf8_bin NOT NULL,
  `data_realizado` date NOT NULL,
  `data_vencimento` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE `frotas` (
  `id` bigint(20) NOT NULL,
  `nome_frota` varchar(20) COLLATE utf8_bin NOT NULL,
...
CREATE TABLE `funcionarios` (
  ...
  `PIS` varchar(30) COLLATE utf8_bin NOT NULL,
  `data_admissao` date NOT NULL,
  `data_demissao` date NOT NULL,
  `email` varchar(100) COLLATE utf8_bin NOT NULL,
  `endereco` varchar(90) COLLATE utf8_bin NOT NULL,
...
CREATE TABLE `lancar_baixa_veiculos` (
  ...
  `comprador` varchar(60) COLLATE utf8_bin NOT NULL,
  `fone_comprador` varchar(40) COLLATE utf8_bin NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE `lancar_viagens` (
  `id` bigint(20) NOT NULL,
  `crtc` varchar(30) COLLATE utf8_bin NOT NULL,
  `data` date NOT NULL,
...
CREATE TABLE `plano_contas` (
  ...
  `sigla_situacao` char(1) COLLATE utf8_bin NOT NULL,
...
CREATE TABLE `situacoes` (
  `id` bigint(20) NOT NULL,
  `tipo_nome` varchar(20) COLLATE utf8_bin NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE `tipos_veiculos` (
  `id` bigint(20) NOT NULL,
  `tipo_de_veiculo` varchar(30) COLLATE utf8_bin NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE `usuarios` (
  ...
  `nivel` varchar(35) COLLATE utf8_bin NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
(1, 'Administrador', '000.000.000-00', 'admin@admin.com', '123', 'admin'),
(2, 'Usuario', '000.000.000-00', 'usuario@admin.com', '123', 'usuario');
...
CREATE TABLE `veiculos` (
  ...
  `placas` varchar(80) COLLATE utf8_bin NOT NULL,
  `dataCompra` date NOT NULL,
  `fk_empresas_id` bigint(20) NOT NULL,
  `fk_frota_id` bigint(20) NOT NULL,
  `tipo_aquisicao` varchar(50) COLLATE utf8_bin NOT NULL,
...
--
ALTER TABLE `empresas`
  ADD CONSTRAINT `fk_cidade` FOREIGN KEY (`fk_cidades_id`) REFERENCES `cidades` (`id`);

--
-- Limitadores para a tabela `fornecedores`
--
ALTER TABLE `fornecedores`
  ADD CONSTRAINT `fk_cidades` FOREIGN KEY (`fk_cidades_id`) REFERENCES `cidades` (`id`);
...
--
ALTER TABLE `funcionarios`
  ADD CONSTRAINT `FK_g7p4bs353x28sq9069xrwphe7` FOREIGN KEY (`fk_cidades_id`) REFERENCES `cidades` (`id`),
